...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"vitepress-allyouneed","description":"Zero-config Obsidian vault → VitePress site","base":"/vitepress-allyouneed/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"sidebar":[{"text":"Overview","collapsed":false,"items":[{"text":"Overview","link":"/"},{"text":"Wikilinks","link":"/showcase/wikilinks"},{"text":"Embeds & Media","link":"/showcase/transclusion"},{"text":"Callouts","link":"/showcase/callouts"},{"text":"Native Syntax","link":"/showcase/syntax"},{"text":"Views","link":"/showcase/views"}],"link":"/showcase"},{"text":"Guide","collapsed":false,"items":[{"text":"Overview","link":"/guide/overview"},{"text":"Advanced","collapsed":false,"items":[{"text":"Custom theme","link":"/guide/advanced/custom-theme"},{"text":"Sidebar recipes","link":"/guide/advanced/sidebar-recipes"},{"text":"Theme & CSS","link":"/guide/advanced/theme-interop"},{"text":"Obsidian compat","link":"/guide/advanced/obsidian-compat"}],"link":"/guide/advanced/custom-theme"},{"text":"Docs","collapsed":false,"items":[{"text":"Frontmatter","link":"/guide/docs/frontmatter"},{"text":"Install","link":"/guide/docs/install"},{"text":"Configure","link":"/guide/docs/configure"},{"text":"Sidebar Auto","link":"/guide/docs/sidebar-auto"},{"text":"DocHeader","link":"/guide/docs/doc-header"},{"text":"Obsidian syntax","link":"/guide/docs/obsidian-syntax"},{"text":"Sidebar Override","link":"/guide/docs/sidebar-override"}],"link":"/guide/docs/frontmatter"}],"link":"/guide/overview"},{"text":"Tour","collapsed":false,"items":[{"text":"v0.5 Tour","link":"/tour/v0.5-tour"},{"text":"v0.3 Tour","link":"/tour/v0.3-tour"},{"text":"Changelog","collapsed":false,"items":[{"text":"v0.1","link":"/tour/changelog/v0.1"},{"text":"v0.2","link":"/tour/changelog/v0.2"},{"text":"v0.3","link":"/tour/changelog/v0.3"},{"text":"v0.4","link":"/tour/changelog/v0.4"},{"text":"v0.5","link":"/tour/changelog/v0.5"}],"link":"/tour/changelog/v0.1"}],"link":"/tour/v0.5-tour"},{"text":"Test","collapsed":true,"items":[{"text":"Header Tests","collapsed":false,"items":[{"text":"01 · 全配置","link":"/test/header/01-full"},{"text":"02 · 只 cover","link":"/test/header/02-cover-only"},{"text":"03 · 深色文字","link":"/test/header/03-text-dark"},{"text":"04 · 重模糊","link":"/test/header/04-heavy-blur"},{"text":"05 · 半透明","link":"/test/header/05-translucent"},{"text":"06 · 位置偏移","link":"/test/header/06-y-offset"},{"text":"07 · 无 cover","link":"/test/header/07-no-cover"},{"text":"08 · 空 frontmatter","link":"/test/header/08-empty"},{"text":"09 · 长标题","link":"/test/header/09-long-title"}],"link":"/test/header"},{"text":"Misc","collapsed":false,"items":[{"text":"🏁 Misc 起点","link":"/"},{"text":"🧪 边缘 case","collapsed":false,"items":[{"text":"超长标题","link":"/test/misc/long-name-this-is-a-deliberately-very-very-long-file-name-for-sidebar-truncation-test"},{"text":"Unicode 混排","link":"/test/misc/unicode-emojis-%E4%B8%AD%E8%8B%B1%E6%96%87%E6%B7%B7%E6%8E%92"}]},{"text":"🔌 集成测试","collapsed":true,"items":[{"text":"KaTeX 数学","link":"/test/misc/math"},{"text":"Mermaid 图","link":"/test/misc/mermaid-diagram"}]},{"text":"🪜 6 层深嵌套","link":"/test/misc/deep/nesting/level-1/level-2/level-3/deep-page"},{"text":"📦 GitHub repo","link":"https://github.com/tangxiaoyi97/vitepress-allyouneed"}],"link":"/test/misc"},{"text":"Transclusion","collapsed":false,"items":[{"text":"Embedded source","link":"/test/transclusion/embedded"},{"text":"Parent","link":"/test/transclusion/parent"}],"link":"/test/transclusion/embedded"},{"text":"Wikilinks(自定义标题)","collapsed":false,"items":[{"text":"Note A","link":"/test/wikilinks/note-a"},{"text":"Note B","link":"/test/wikilinks/note-b"},{"text":"中文笔记","link":"/test/wikilinks/%E4%B8%AD%E6%96%87%E7%AC%94%E8%AE%B0"},{"text":"死链测试","link":"/test/wikilinks/dead-link"}]}]}],"nav":[{"text":"Perspectives","items":[{"text":"Graph","link":"/_perspectives_/graph"},{"text":"Stats","link":"/_perspectives_/stats"},{"text":"Tags","link":"/_perspectives_/tags"}]}]},"locales":{"root":{"label":"English","lang":"en-US","themeConfig":{"nav":[{"text":"Home","link":"/","activeMatch":"^/(?!guide/|showcase/|tour/|test/|zh/)"},{"text":"Showcase","link":"/showcase/","activeMatch":"^/showcase/"},{"text":"Guide","link":"/guide/overview","activeMatch":"^/guide/"},{"text":"Tour","link":"/tour/v0.5-tour","activeMatch":"^/tour/"},{"text":"Test","link":"/test/header/","activeMatch":"^/test/"},{"text":"Perspectives","items":[{"text":"Graph","link":"/_perspectives_/graph"},{"text":"Stats","link":"/_perspectives_/stats"},{"text":"Tags","link":"/_perspectives_/tags"}]}]}},"zh":{"label":"简体中文","lang":"zh-CN","link":"/zh/","themeConfig":{"nav":[{"text":"首页","link":"/zh/","activeMatch":"^/zh/(?!guide/|showcase/|tour/)"},{"text":"功能展示","link":"/zh/showcase/","activeMatch":"^/zh/showcase/"},{"text":"文档","link":"/zh/guide/overview","activeMatch":"^/zh/guide/"},{"text":"巡览","link":"/zh/tour/v0.5-tour","activeMatch":"^/zh/tour/"},{"text":"测试","link":"/test/header/","activeMatch":"^/test/"},{"text":"Perspectives","items":[{"text":"Graph","link":"/_perspectives_/graph"},{"text":"Stats","link":"/_perspectives_/stats"},{"text":"Tags","link":"/_perspectives_/tags"}]}],"sidebar":[{"text":"Zh","collapsed":false,"items":[{"text":"Guide","collapsed":false,"items":[{"text":"Overview","link":"/zh/guide/overview"},{"text":"Advanced","collapsed":false,"items":[{"text":"Custom theme","link":"/zh/guide/advanced/custom-theme"},{"text":"Sidebar recipes","link":"/zh/guide/advanced/sidebar-recipes"},{"text":"Theme & 样式覆盖","link":"/zh/guide/advanced/theme-interop"},{"text":"Obsidian 兼容","link":"/zh/guide/advanced/obsidian-compat"}],"link":"/zh/guide/advanced/custom-theme"},{"text":"Docs","collapsed":false,"items":[{"text":"Frontmatter","link":"/zh/guide/docs/frontmatter"},{"text":"Install","link":"/zh/guide/docs/install"},{"text":"Configure","link":"/zh/guide/docs/configure"},{"text":"Sidebar Auto","link":"/zh/guide/docs/sidebar-auto"},{"text":"DocHeader","link":"/zh/guide/docs/doc-header"},{"text":"Obsidian 语法","link":"/zh/guide/docs/obsidian-syntax"},{"text":"Sidebar Override","link":"/zh/guide/docs/sidebar-override"}],"link":"/zh/guide/docs/frontmatter"}],"link":"/zh/guide/overview"},{"text":"总览","collapsed":false,"items":[{"text":"总览","link":"/"},{"text":"Wikilinks","link":"/showcase/wikilinks"},{"text":"嵌入 & 媒体","link":"/showcase/transclusion"},{"text":"Callouts","link":"/showcase/callouts"},{"text":"原生语法","link":"/showcase/syntax"},{"text":"三大视图","link":"/showcase/views"}],"link":"/zh/showcase"},{"text":"Tour","collapsed":false,"items":[{"text":"v0.3 Tour","link":"/zh/tour/v0.3-tour"},{"text":"v0.5 Tour","link":"/zh/tour/v0.5-tour"},{"text":"Changelog","collapsed":false,"items":[{"text":"v0.1","link":"/zh/tour/changelog/v0.1"},{"text":"v0.2","link":"/zh/tour/changelog/v0.2"},{"text":"v0.3","link":"/zh/tour/changelog/v0.3"},{"text":"v0.4","link":"/zh/tour/changelog/v0.4"},{"text":"v0.5","link":"/zh/tour/changelog/v0.5"}],"link":"/zh/tour/changelog/v0.1"}],"link":"/zh/tour/v0.3-tour"}]}]}}},"scrollOffset":134,"cleanUrls":true}'));
...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/vitepress-allyouneed/";
...
function validateVaultData(parsed) {
...
function useVaultData(fileName = "vault-data.json") {
  const data = ref(null);
  ...
  async function load() {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(
          `vault-data.json fetch failed (${res.status}). Make sure vitepress-allyouneed/vite plugin is installed and srcDir is correct.`
        );
      }
      let parsed;
      try {
        ...
        throw new Error(
          `vault-data.json parse failed: ${jsonErr instanceof Error ? jsonErr.message : String(jsonErr)}`
        );
      }
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const links = computed(() => {
      ...
      return data.value.edges.filter(
        (e) => e && typeof e.source === "string" && typeof e.target === "string" && ids.has(e.source) && ids.has(e.target)
      ).map((e) => ({
        source: e.source,
        target: e.target,
    ...
    const neighborsMap = computed(() => {
      var _a, _b;
      const m = /* @__PURE__ */ new Map();
      for (const n of nodes.value) m.set(n.id, /* @__PURE__ */ new Set([n.id]));
      for (const e of links.value) {
        const s = e.source.id ?? e.source;
        const t = e.target.id ?? e.target;
        (_a = m.get(s)) == null ? void 0 : _a.add(t);
        (_b = m.get(t)) == null ? void 0 : _b.add(s);
      }
      return m;
    });
    function build() {
      ...
      simulation == null ? void 0 : simulation.stop();
      if (fitTimer !== null) {
      ...
      const linkSel = g.append("g").attr("class", "ayn-graph-edges").selectAll("line").data(simLinks).join("line").attr(
        "class",
        (d) => d.type === "transclusion" ? "ayn-graph-edge ayn-graph-edge--embed" : "ayn-graph-edge"
      );
      const nodeSel = g.append("g").attr("class", "ayn-graph-nodes").selectAll("g").data(simNodes, (d) => d.id).join("g").attr("class", "ayn-graph-node");
      const nodeR = (d) => 4 + Math.min(d.inDegree, 8);
      ...
      nodeSel.append("text").attr("class", "ayn-graph-label").attr("dy", (d) => nodeR(d) + 11).attr("text-anchor", "middle").text((d) => d.title);
      let kickRender = () => {
      };
      let dragMoved = false;
      ...
      }).on("mouseenter", (_evt, d) => applyFocus(d.id, nodeSel, linkSel)).on("mouseleave", () => clearFocus(nodeSel, linkSel)).call(
        drag().on("start", (event, d) => {
          dragMoved = false;
          if (!event.active) simulation == null ? void 0 : simulation.alphaTarget(0.3).restart();
          kickRender();
          d.fx = d.x;
          d.fy = d.y;
        }).on("drag", (event, d) => {
          ...
          if (!event.active) simulation == null ? void 0 : simulation.alphaTarget(0);
          d.fx = null;
          d.fy = null;
        })
      );
      ...
      const labelSel = g.selectAll("text.ayn-graph-label");
      const applyLabelZoom = (k) => {
        let t;
        if (k >= LABEL_FULL) t = 1;
      ...
      zoomBehavior = zoom().scaleExtent([0.15, 6]).wheelDelta((event) => -event.deltaY * (event.deltaMode === 1 ? 0.025 : 15e-4)).on("zoom", (event) => {
      ...
      const cx0 = width / 2;
      const cy0 = height / 2;
      simulation = forceSimulation(simNodes).alphaDecay(isVeryHeavy ? 0.028 : isHeavy ? 0.022 : 0.0165).alphaMin(1e-3).velocityDecay(isVeryHeavy ? 0.45 : 0.38).force(
        "link",
        forceLink(simLinks).id((d) => d.id).distance(isHeavy ? 48 : 66).strength((l) => l.type === "transclusion" ? 0.75 : 0.55)
      ).force(
        "charge",
        forceManyBody().strength(isVeryHeavy ? -55 : isHeavy ? -75 : -110).distanceMax(isHeavy ? 400 : 600).theta(0.9)
      ).force("x", forceX(cx0).strength(0.045)).force("y", forceY(cy0).strength(0.045)).force(
        "collide",
        forceCollide().radius((d) => collideR + Math.min(d.inDegree, 6)).strength(0.85).iterations(isVeryHeavy ? 1 : 2)
      );
      let dirty = false;
      const paint = () => {
    ...
    function fitToView(svg, simNodes, width, height) {
      ...
      const h2 = maxY - minY + padding * 2;
      if (w <= 0 || h2 <= 0) return;
      const scale = Math.min(width / w, height / h2, 1.5);
    ...
    function applyFocus(hoveredId, nodeSel, linkSel) {
      const neighbors = neighborsMap.value.get(hoveredId) ?? /* @__PURE__ */ new Set([hoveredId]);
      nodeSel.classed("is-active", (n) => n.id === hoveredId).classed("is-related", (n) => n.id !== hoveredId && neighbors.has(n.id)).classed("is-dimmed", (n) => !neighbors.has(n.id));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ayn-view ayn-graph" }, _attrs))}>`);
      if (unref(loading)) {
        _push(`<div class="ayn-view-loading">Loading…</div>`);
      } else if (unref(error)) {
        _push(`<div class="ayn-view-error">Failed to load: ${ssrInterpolate(unref(error))}</div>`);
      } else if (tooHeavy.value) {
        _push(`<div class="ayn-view-empty"> Graph has ${ssrInterpolate(nodes.value.length)} nodes (max ${ssrInterpolate(maxNodes.value)}); disabled to prevent slowdown. <br>Raise the limit via the <code>:max-nodes</code> prop, or use the Tags / Stats views instead. </div>`);
      } else {
        _push(`<div class="ayn-graph-container"><svg class="ayn-graph-svg"></svg></div>`);
      }
      _push(`</div>`);
    };
  }
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../dist/theme/components/VaultGraph.vue");
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const recent = computed(() => {
      var _a, _b;
      return ((_b = (_a = data.value) == null ? void 0 : _a.stats) == null ? void 0 : _b.mostRecent) ?? [];
    });
    function fmtNum(n) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ayn-view ayn-stats" }, _attrs))}>`);
      if (unref(loading)) {
        _push(`<div class="ayn-view-loading">Loading…</div>`);
      } else if (unref(error)) {
        _push(`<div class="ayn-view-error">Failed to load: ${ssrInterpolate(unref(error))}</div>`);
      } else if (unref(data)) {
        _push(`<!--[--><div class="ayn-stats-cards"><!--[-->`);
        ssrRenderList(cards.value, (c) => {
          _push(`<div class="ayn-stats-card"><div class="ayn-stats-number">${ssrInterpolate(fmtNum(c.value))}</div><div class="ayn-stats-label">${ssrInterpolate(c.label)}</div></div>`);
        });
        _push(`<!--]--></div><h2 class="ayn-stats-section-title">Recent activity</h2><ul class="ayn-stats-recent"><!--[-->`);
        ssrRenderList(recent.value, (f) => {
          _push(`<li><a${ssrRenderAttr("href", unref(withBase)(f.url))}>${ssrInterpolate(f.title)}</a><span class="ayn-stats-recent-time">${ssrInterpolate(fmtDate(f.mtime))}</span></li>`);
        });
        _push(`<!--]--></ul>`);
        if ((unref(data).stats.totalWarnings ?? 0) > 0) {
          _push(`<div class="ayn-stats-warnings"><strong>⚠ ${ssrInterpolate(unref(data).stats.totalWarnings)} scan warnings</strong><small>(see dev server logs for details)</small></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="ayn-stats-meta"> Generated at ${ssrInterpolate(fmtDate(unref(data).meta.generatedAt))} · vitepress-allyouneed ${ssrInterpolate(unref(data).meta.pluginVersion)}</div><!--]-->`);
      } else {
        _push(`<div class="ayn-view-empty">No data</div>`);
      }
      _push(`</div>`);
    };
  }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../dist/theme/components/VaultStats.vue");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const tagList = computed(() => {
      ...
      const filtered = f ? entries.filter(([t]) => t.toLowerCase().includes(f)) : entries;
      return filtered.sort((a, b) => b[1].count - a[1].count);
    });
    const activeFiles = computed(() => {
      var _a;
      if (!data.value || !activeTag.value) return [];
      return ((_a = data.value.tags[activeTag.value]) == null ? void 0 : _a.files) ?? [];
    });
    ...
    function shownTags(tags) {
      return (tags ?? []).slice(0, MAX_INLINE_TAGS);
    }
    function extraTagCount(tags) {
      return Math.max(0, ((tags == null ? void 0 : tags.length) ?? 0) - MAX_INLINE_TAGS);
    }
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ayn-view ayn-tags" }, _attrs))}>`);
      if (unref(loading)) {
        _push(`<div class="ayn-view-loading">Loading…</div>`);
      } else if (unref(error)) {
        _push(`<div class="ayn-view-error">Failed to load: ${ssrInterpolate(unref(error))}</div>`);
      } else if (unref(data)) {
        _push(`<!--[--><div class="ayn-tags-search"><span class="ayn-tags-search-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><path d="m21 21-4.3-4.3"></path></svg></span><input${ssrRenderAttr("value", filter.value)} type="search" placeholder="Search tags..."></div><div class="ayn-tags-cloud-card">`);
        if (tagList.value.length === 0) {
          _push(`<div class="ayn-tags-empty"> No tags found matching &quot;${ssrInterpolate(filter.value)}&quot; </div>`);
        } else {
          _push(`<div class="ayn-tags-chips"><!--[-->`);
          ssrRenderList(tagList.value, ([tag, info]) => {
            _push(`<button class="${ssrRenderClass([{ "is-active": activeTag.value === tag }, "ayn-tag-chip"])}"${ssrRenderAttr("title", `${info.count} notes`)}><span class="ayn-tag-chip-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" x2="20" y1="9" y2="9"></line><line x1="4" x2="20" y1="15" y2="15"></line><line x1="10" x2="8" y1="3" y2="21"></line><line x1="16" x2="14" y1="3" y2="21"></line></svg></span><span class="ayn-tag-chip-name">${ssrInterpolate(tag)}</span><span class="ayn-tag-chip-count">${ssrInterpolate(info.count)}</span></button>`);
          });
          _push(`<!--]--></div>`);
        }
        _push(`</div>`);
        if (activeTag.value) {
          _push(`<div class="ayn-tag-notes"><div class="ayn-tag-notes-table-header"><span class="ayn-tag-notes-table-header-name">NAME / TAGS</span><span class="ayn-tag-notes-table-header-date">DATE</span></div>`);
          if (activeFiles.value.length) {
            _push(`<ul class="ayn-tag-notes-table"><!--[-->`);
            ssrRenderList(activeFiles.value, (f) => {
              _push(`<li class="ayn-tag-note-row"><a${ssrRenderAttr("href", unref(withBase)(f.url))} class="ayn-tag-note-row-link"><div class="ayn-tag-note-row-left"><span class="ayn-tag-note-row-title"${ssrRenderAttr("title", f.title)}>${ssrInterpolate(f.title)}</span><!--[-->`);
              ssrRenderList(shownTags(f.otherTags), (ot) => {
                _push(`<span class="ayn-tag-note-row-othertag">${ssrInterpolate(ot)}</span>`);
              });
              _push(`<!--]-->`);
              if (extraTagCount(f.otherTags) > 0) {
                _push(`<span class="ayn-tag-note-row-othertag ayn-tag-note-row-othertag--more"${ssrRenderAttr("title", f.otherTags.join(", "))}>+${ssrInterpolate(extraTagCount(f.otherTags))}</span>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div><div class="ayn-tag-note-row-right"><span class="ayn-tag-note-row-path">${ssrInterpolate(basename(f.path))}</span><span class="ayn-tag-note-row-date">${ssrInterpolate(fmtDate(f.mtime))}</span></div></a></li>`);
            });
            _push(`<!--]--></ul>`);
          } else {
            _push(`<div class="ayn-tag-notes-empty"> No notes found in this tag. </div>`);
          }
          _push(`</div>`);
        } else {
          _push(`<!---->`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../dist/theme/components/Tags.vue");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const cfg = computed(() => {
      const t = theme2.value.allyouneed;
      return {
        enabled: true,
        hideH1: true,
        showDates: true,
    ...
    function readBannerCfg() {
      const b = frontmatter.value.banner ?? {};
      const asStr = (v, fb) => typeof v === "string" || typeof v === "number" ? String(v) : fb;
    ...
    const banner = computed(() => readBannerCfg());
    ...
    const overlayStyle = computed(() => {
      ...
      const mid = o * 0.6;
      return {
        background: `linear-gradient(to top, rgba(17, 24, 39, ${top}) 0%, rgba(17, 24, 39, ${mid}) 55%, rgba(17, 24, 39, 0) 100%)`
      };
    });
    const pageTitle = computed(() => {
      ...
      const base = ((_a = rel.split("/").pop()) == null ? void 0 : _a.replace(/\.(md|markdown)$/i, "")) ?? "";
      return base;
    });
    const tags = computed(() => {
    ...
    const createdAt = computed(() => formatDate(frontmatter.value.created));
    ...
    function measureOnce(retry) {
      ...
      (_a = clone.querySelector(".ayn-doc-header")) == null ? void 0 : _a.remove();
      wordCount.value = countWords(clone.textContent ?? "");
    }
    const CJK_RE = /[぀-ヿ㐀-䶿一-鿿豈-﫿가-힯]/g;
    function countWords(text) {
      const cjk = (text.match(CJK_RE) ?? []).length;
      const latin = text.replace(CJK_RE, " ").trim().split(/\s+/).filter(Boolean).length;
      return cjk + latin;
    }
    ...
    const hasMetaLine = computed(
      () => Boolean(cfg.value.showWordCount && readingTime.value > 0) || Boolean(cfg.value.showDates && (createdAt.value || updatedAt.value))
    );
    const hasTagsRow = computed(
      () => Boolean(cfg.value.showTags) && tags.value.length > 0
    );
    const showTitleDivider = computed(
      () => Boolean(pageTitle.value) && (hasMetaLine.value || hasTagsRow.value)
    );
    const viewsPrefix = computed(() => {
      var _a;
      const t = theme2.value;
      return ((_a = t.allyouneed) == null ? void 0 : _a.viewsUrlPrefix) ?? "_perspectives_";
    });
    const isPerspectiveView = computed(() => {
      const rel = page.value.relativePath ?? "";
    ...
    const modeClasses = computed(() => {
      if (hasBanner.value) {
        return [
          ...
          banner.value.text === "dark" ? "ayn-doc-header--text-dark" : "ayn-doc-header--text-light"
        ];
      }
      return ["ayn-doc-header--no-banner"];
    });
    function applyH1Hide() {
    ...
    watch(
      [visible, () => cfg.value.hideH1, pageTitle, () => page.value.relativePath],
      applyH1Hide
    );
    return (_ctx, _push, _parent, _attrs) => {
      if (visible.value) {
        _push(`<header${ssrRenderAttrs(mergeProps({
          class: ["ayn-doc-header", modeClasses.value]
        }, _attrs))}>`);
        if (hasBanner.value) {
          _push(`<div class="ayn-doc-banner-bg" style="${ssrRenderStyle(bgStyle.value)}"></div>`);
        } else {
          _push(`<!---->`);
        }
        if (hasBanner.value) {
          _push(`<div class="ayn-doc-banner-overlay" style="${ssrRenderStyle(overlayStyle.value)}"></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="ayn-doc-header-inner">`);
        if (pageTitle.value) {
          _push(`<div class="ayn-doc-banner-title" role="heading" aria-level="1"${ssrRenderAttr("title", pageTitle.value)}>${ssrInterpolate(pageTitle.value)}</div>`);
        } else {
          _push(`<!---->`);
        }
        if (showTitleDivider.value) {
          _push(`<div class="ayn-doc-title-divider"></div>`);
        } else {
          _push(`<!---->`);
        }
        if (hasMetaLine.value) {
          _push(`<div class="ayn-doc-meta-line">`);
          if (cfg.value.showWordCount && readingTime.value > 0) {
            _push(`<span class="ayn-doc-meta-item"><svg class="ayn-doc-meta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> ${ssrInterpolate(readingTime.value)} min read </span>`);
          } else {
            _push(`<!---->`);
          }
          if (cfg.value.showWordCount && readingTime.value > 0 && cfg.value.showDates && createdAt.value) {
            _push(`<span class="ayn-doc-meta-sep">•</span>`);
          } else {
            _push(`<!---->`);
          }
          if (cfg.value.showDates && createdAt.value) {
            _push(`<span class="ayn-doc-meta-item"><svg class="ayn-doc-meta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg> Created ${ssrInterpolate(createdAt.value)}</span>`);
          } else {
            _push(`<!---->`);
          }
          if (cfg.value.showDates && createdAt.value && updatedAt.value) {
            _push(`<span class="ayn-doc-meta-sep">•</span>`);
          } else {
            _push(`<!---->`);
          }
          if (cfg.value.showDates && updatedAt.value) {
            _push(`<span class="ayn-doc-meta-item"><svg class="ayn-doc-meta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polygon points="14 2 18 6 7 17 3 17 3 13 14 2"></polygon><line x1="3" y1="22" x2="21" y2="22"></line></svg> Updated ${ssrInterpolate(updatedAt.value)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        if (hasTagsRow.value) {
          _push(`<div class="ayn-doc-tags"><!--[-->`);
          ssrRenderList(tags.value, (t) => {
            _push(`<a class="ayn-doc-tag"${ssrRenderAttr("href", tagHref(t))}>#${ssrInterpolate(t)}</a>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../dist/theme/components/DocHeader.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const LayoutComp = theme$1.Layout;
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(LayoutComp)), _attrs, createSlots({
        "doc-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../dist/theme/components/Layout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
function defineTheme(userTheme = {}) {
  return {
    extends: userTheme.extends ?? theme$1,
    Layout: userTheme.Layout ?? _sfc_main,
    setup() {
      var _a;
      (_a = userTheme.setup) == null ? void 0 : _a.call(userTheme);
    },
    enhanceApp(ctx) {
      var _a;
      ctx.app.component("VaultGraph", _sfc_main$4);
      ctx.app.component("VaultStats", _sfc_main$3);
      ctx.app.component("Tags", _sfc_main$2);
      ctx.app.component("DocHeader", _sfc_main$1);
