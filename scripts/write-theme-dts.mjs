...
export interface UseVaultDataOptions { immediate?: boolean }

export declare function useVaultData(
  fileName?: string,
  options?: UseVaultDataOptions,
): UseVaultDataResult

export declare const VaultGraph: DefineComponent<{
  maxNodes?: number
  dataFileName?: string
  vaultData?: VaultData
  focusNodeId?: string
}>
export declare const VaultStats: DefineComponent<{ dataFileName?: string }>
export declare const Tags: DefineComponent<{ dataFileName?: string }>
export declare const Layout: DefineComponent<{ layout?: Component }>
export declare const DocHeader: DefineComponent<Record<string, never>>
export declare const LocalGraph: DefineComponent<{
